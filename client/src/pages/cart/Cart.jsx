...
import { productsImages } from "../product/ProductImagesUtil";
...
export default function CartView() {
  ...
  const findProduct = (productId) => {
    ...
    return tempProducts.filter((product) => product.productId === productId)[0];
  };
            ...
            <div className="card">
              <div className="table-responsive">
                <table className="table table-borderless">
                  ...
                  <tbody>
                    {Object.keys(productsWithQuantity).map((productKey) => {
                      return (
                        <tr>
                          <td>
                            <div className="row">
                              <div className="col-3 d-none d-md-block">
                                <img
                                  src={
                                    productsImages[productsWithQuantity[productKey].product.img]
                                  }
                                  width="80"
                                  alt="..."
                                />
                              ...
                              <div className="col">
                                ...
                                >
                                  {
                                    productsWithQuantity[productKey].product
                                      .name
                                  }
                                </Link>
                          ...
                          <td>
                            <div className="input-group input-group-sm mw-140">
                              {productsWithQuantity[productKey].quantity}
                            </div>
                          </td>
                          <td>
                            <var className="price">
                              ...
                              {`${
                                productsWithQuantity[productKey].quantity *
                                productsWithQuantity[productKey].product.price
                              }`}
                            </var>
            ...
            <div className="card">
              <div className="card-body">
                <dl className="row border-bottom">
                  ...
                  <dd className="col-6 text-right">${tax}</dd>
